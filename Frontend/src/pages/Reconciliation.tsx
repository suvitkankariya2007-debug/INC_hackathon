    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Reconciliation</h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Match bank statement rows with ledger transactions</p>
                </div>
            ...
            {showUpload && (
                <Card className="bg-blue-50 border-blue-200">
                    <div className="flex flex-col items-center py-6">
                        ...
                        <input type="file" accept=".csv" onChange={handleFileUpload} className="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-600 file:text-white hover:file:bg-blue-700" />
                    </div>
                </Card>
            )}
            ...
            {!report && (
                <div className="flex flex-col items-center justify-center py-24 text-gray-400 dark:text-gray-500">
                    ...
                    <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-300 mb-2">No Bank Statement Uploaded</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <h3 className="font-bold text-gray-700 dark:text-gray-200 uppercase tracking-tight">Auto-Matched ({report.matched.length})</h3>
                        </div>
                        {report.matched.map((item: any) => (
                            <Card key={item.id} className="border-l-4 border-l-green-500 hover:shadow-md transition-shadow">
                                ...
                                {item.match && (
                                    <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700 text-[10px] text-gray-500 dark:text-gray-400">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <h3 className="font-bold text-gray-700 dark:text-gray-200 uppercase tracking-tight">Possible Matches ({report.possible.length})</h3>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <h3 className="font-bold text-gray-700 dark:text-gray-200 uppercase tracking-tight">Unmatched ({report.unmatched.length})</h3>
                        </div>
