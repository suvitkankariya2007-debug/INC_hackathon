        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh] p-4">
            <div className="w-full max-w-md space-y-8">
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">LedgerAI</h1>
                    <p className="text-gray-600">Smart Accounting & Audit Platform</p>
                </div>
                ...
                <Card>
                    <h2 className="text-xl font-bold text-gray-800 mb-6">Login to Existing Firm</h2>
                        ...
                        <div className="space-y-3 mb-6">
                            {state.entities.map(entity => (
                                <button
                                    ...
                                    className="w-full text-left px-4 py-3 rounded-lg border border-gray-200 hover:border-blue-500 hover:bg-blue-50 transition-all flex justify-between items-center"
                                >
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-white text-gray-500">Or register new firm</span>
                        </div>
                    </div>
